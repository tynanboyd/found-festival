		...
		<div class="modal_content">
			...
			<div class="forgotpass_form_wrap">
				...
				<center>
					...
					<span class="createpass_loading" style="display: none; margin-left: 10px;"><img src="<?php echo pb_backupbuddy::plugin_url(); ?>/images/loading.gif" alt="' . __('Loading...', 'it-l10n-backupbuddy' ) . '" title="' . __('Loading...', 'it-l10n-backupbuddy' ) . '" width="16" height="16" style="vertical-align: -3px;"></span>
				</center>
